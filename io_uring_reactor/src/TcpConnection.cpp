...
void TcpConnection::send_inLoop_with_uring(const string &buf)
{
    loop_->poller_->add_socket_write(channel_.get(), IOSQE_CQE_SKIP_SUCCESS, buf.c_str());
